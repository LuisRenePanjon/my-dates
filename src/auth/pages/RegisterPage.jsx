  ...
  return (
    <AuthLayout>
        <div className='w-full border-dashed border-[1px] border-spacing-1 mt-10 p-5 rounded-lg py-7 shadow-2xl'>
            <h1 className='text-3xl font-bold text-center text-white'>Registrarse</h1>
            ...
            <form className='space-y-6' onSubmit={() => {}}>
                ...
                <div className='rounded-md shadow-sm -space-y-px'>
                    <div className='py-2 flex flex-row  justify-between'>
                        ...
                        <input
                            className='appearance-none rounded-md relative block pl-3  py-2 border border-gray-300 placeholder-gray-500 text-gray-900  focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm'
